...
public partial class UnionSurveyProdContext : DbContext
{
    public UnionSurveyProdContext()
    {
    }

    public UnionSurveyProdContext(DbContextOptions<UnionSurveyProdContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.; Database=UnionSurveyProd;User Id=sa;Password=Numerical123;TrustServerCertificate=True;MultipleActiveResultSets=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AspNetRo__3214EC0724788F51");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AspNetRo__3214EC0777CBF054");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AspNetUs__3214EC07A957DC4A");
            ...
            entity.HasMany(d => d.Roles).WithMany(p => p.Users)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("UserId", "RoleId").HasName("PK__AspNetUs__AF2760AD27D27A28");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AspNetUs__3214EC0786FFC891");
        ...
        {
            entity.HasKey(e => new { e.LoginProvider, e.ProviderKey }).HasName("PK__AspNetUs__2B2C5B5242903633");
        ...
        {
            entity.HasKey(e => new { e.UserId, e.LoginProvider, e.Name }).HasName("PK__AspNetUs__8CC498417EFBE7D8");
